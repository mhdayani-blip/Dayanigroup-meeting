...
segments = [
    ("امروز لازم نیست با عجله، روزم را شروع کنم.", 0.40),
    ("می‌توانم چند لحظه آرام بمانم، نفس بکشم، و اجازه بدهم ذهنم از شتاب فاصله بگیرد.", 0.45),
    ("برای فرصت تازه‌ی امروز، برای سلامتی، و برای توانایی فکر کردن و ساختن، سپاسگزارم.", 0.45),
    ("قرار نیست همه چیز همین حالا کامل باشد.", 0.40),
    ("کافی است با آرامش بیشتر، دقت بیشتر، و ذهنی روشن‌تر، قدم بعدی را درست بردارم.", 0.45),
    ("امروز انرژی‌ام را برای چیزهایی نگه می‌دارم که واقعاً ارزش دارند.", 0.40),
...
scipy.io.wavfile.write(
    OUT / "pocket-farsi-female-test.wav",
